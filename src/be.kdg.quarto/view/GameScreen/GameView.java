...
public class GameView extends StackPane {
    ...
    private void initialiseNodes() {
        ...
        quarto = CreateHelper.createButton("Quarto", new String[]{"quarto-button","green-button","default-button"});
        placePiece = CreateHelper.createButton("Place Piece", new String[]{"place-piece-button","default-button"});
        choosePiece = CreateHelper.createButton("Choose Piece", new String[]{"choose-piece-button","default-button"});
